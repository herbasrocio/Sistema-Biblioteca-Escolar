-- =====================================================
-- Script: Migrar Datos Existentes a Inscripciones (CORREGIDO)
...
SELECT
    ...
    a.Division,
    a.FechaRegistro,
    'Activo' -- Todos los alumnos existentes se consideran activos
FROM Alumno a
...
PRINT '  OK ' + CAST(@AlumnosMigrados AS NVARCHAR(10)) + ' alumnos migrados'
...
PRINT '  - Alumnos sin inscripcion: ' + CAST(@AlumnosSinInscripcion AS NVARCHAR(10))
...
BEGIN
    PRINT ''
    PRINT 'ADVERTENCIA: Hay alumnos sin inscripcion'
END

PRINT ''
PRINT 'NOTA IMPORTANTE:'
PRINT '  - Los campos Grado y Division en la tabla Alumno ahora son historicos'
