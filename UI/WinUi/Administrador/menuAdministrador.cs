...
namespace UI.WinUi.Administrador
{
    public partial class menuAdministrador : Form
    {
        ...
        public menuAdministrador(Usuario usuario) : this()
        {
        ...
        private void ActualizarTextos()
        {
            if (_usuarioLogueado != null)
            {
                ...
                this.Text = LanguageManager.Translate("menu_administrador");
                lblSistemaBiblio.Text = LanguageManager.Translate("sistema_biblioteca");
                lblUsuarioLogeado.Text = $"{LanguageManager.Translate("usuario")}: {_usuarioLogueado.Nombre}";
                ...
                // Traducir botones
                btnGestionUsuarios.Text = LanguageManager.Translate("gestion_usuarios");
                btnCatalogo.Text = LanguageManager.Translate("catalogo");
                btnGestionarAlumnos.Text = LanguageManager.Translate("gestionar_alumnos");
                btnPrestamos.Text = LanguageManager.Translate("prestamos");
                btnDevoluciones.Text = LanguageManager.Translate("devoluciones");
                btnReportes.Text = LanguageManager.Translate("reportes");
            }
        }
        ...
        private void lblVeterinariaVetCare_Click(object sender, EventArgs e)
        {
