    ...
    public static class FamiliaBLL
    {
        ...
        public static Familia CrearRol(string nombreRol)
        {
            try
            {
                ...
                ServicesSecurity.DAL.Implementations.FamiliaRepository.Current.Add(nuevoRol);
        ...
        public static void EliminarRol(Guid idFamilia)
        {
            try
            {
                ...
                var usuariosConRol = ServicesSecurity.DAL.Implementations.UsuarioFamiliaRepository.Current
                    .SelectAll()
                ...
                {
                    var relacion = new ServicesSecurity.DomainModel.Security.FamiliaPatente
                    {
                        idFamilia = fp.idFamilia,
                        idPatente = fp.idPatente
                    };
                    ServicesSecurity.DAL.Implementations.FamiliaPatenteRepository.Current.DeleteRelacion(relacion);
                }

                // Eliminar el rol
                ServicesSecurity.DAL.Implementations.FamiliaRepository.Current.Delete(idFamilia);
            }
            catch (ValidacionException)
            {
                throw;
